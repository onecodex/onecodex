...
class BaseSampleCollection(
    ...
    def _parse_classification_config_args(
        self, metric: Metric | None, rank: Rank | None
    ) -> tuple[Metric, Rank]:
    ...
    def __repr__(self) -> str:
        return (
            f"<SampleCollection[{self._oc_model.__name__}] length={len(self):,} : {self._res_list}>"
        )
    ...
    def _metadata_fetch(
        ...
        results_df : pd.DataFrame
            A dataframe of classification results generated by to_classification_df.
