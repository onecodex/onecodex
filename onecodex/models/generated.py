...
#   timestamp: 2025-07-09T20:57:04+00:00
...
class User(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/users/[a-f0-9]{16}$'
    )
...
class Dependency(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/analyses/[a-f0-9]{16}$'
    )
...
class Job(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/jobs/[a-f0-9]{16}$'
    )


class Sample(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/samples/[a-f0-9]{16}$'
    )


class AnalysisFileDetailsSchema(BaseModel):
    filename: str = Field(
        ..., description='The filename of the output file.', title='Filename'
    )
    size: int = Field(..., description='File size in bytes.', ge=1, title='Size')
    url: AnyUrl = Field(..., description='Pre-signed download URL.', title='Url')
...
class DocumentDownloadSchema(BaseModel):
    download_uri: AnyUrl = Field(
        ..., description='The presigned download URL.', title='Download Uri'
    )
...
class DocumentInitUploadResponse(BaseModel):
    ...
    upload_url: AnyUrl = Field(
        ..., description='The URL to POST the document to.', title='Upload Url'
    )
...
class DocumentInitUploadSchema(BaseModel):
    ...
    size: int = Field(
        ..., description='The size of the file in bytes.', ge=1, title='Size'
    )


class DocumentRef(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/documents/[a-f0-9]{16}$'
    )
...
class Size(RootModel[int]):
    root: int = Field(
        ..., description='The size of the document in bytes.', ge=1, title='Size'
    )
...
class DocumentSchema(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='ExcludeFromOpenAPI', title='Description'
    )
    ...
    valid_until: Optional[str] = Field(
        None, description='ExcludeFromOpenAPI', title='Valid Until'
    )
...
class EventSchema(BaseModel):
    ...
    payload: Dict[str, Any] = Field(
        ..., description='The webhook payload.', title='Payload'
    )
    status: Status = Field(
...
class ProjectRef(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/projects/[a-f0-9]{16}$'
    )
...
class ProjectSchema(BaseModel):
    ...
    external_id: Optional[str] = Field(
        None, examples=['a1b2c3d4e5f67890'], title='External Id'
    )
    name: Optional[str] = Field(None, title='Name')
...
class SampleCancelUploadResponse(BaseModel):
    message: str = Field(
        ..., description='A detailed success or failure message.', title='Message'
    )
    success: bool = Field(
        ...,
...
class UncompressedSize(RootModel[int]):
    root: int = Field(
        ..., description='ExcludeFromOpenAPI', ge=1, title='Uncompressed Size'
    )


class SampleConfirmUploadSchema(BaseModel):
    file_type: Optional[FileType] = Field(
        None, description='ExcludeFromOpenAPI', title='File Type'
    )
    md5: Optional[str] = Field(None, description='ExcludeFromOpenAPI', title='Md5')
    n_bases: Optional[NBases] = Field(
        None, description='ExcludeFromOpenAPI', title='N Bases'
    )
    n_lines: Optional[NLines] = Field(
        None, description='ExcludeFromOpenAPI', title='N Lines'
    )
    n_sequences: Optional[NSequences] = Field(
        None, description='ExcludeFromOpenAPI', title='N Sequences'
    )
    s3_key: Optional[str] = Field(
        None, description='ExcludeFromOpenAPI', title='S3 Key'
    )
    ...
    sha256: Optional[str] = Field(
        None, description='ExcludeFromOpenAPI', title='Sha256'
    )
...
class SampleDownloadUriSchema(BaseModel):
    download_uri: AnyUrl = Field(
        ..., description='A pre-signed download link.', title='Download Uri'
    )
    expires_in_hours: int = Field(
        ...,
...
class PairedUri(RootModel[AnyUrl]):
    root: AnyUrl = Field(..., title='Paired Uri')
...
class PairedEndUploadUrl(RootModel[AnyUrl]):
    root: AnyUrl = Field(
        ...,
...
class SampleInitUploadResponse(BaseModel):
    ...
    paired_end_upload_url: Optional[PairedEndUploadUrl] = Field(
        None,
        description='Object storage location to POST the paired end file to (optional).',
        title='Paired End Upload Url',
    )
...
class Size2(RootModel[int]):
    root: int = Field(
        ..., description='The size of the file in bytes.', ge=0, title='Size'
    )
...
class Metadata(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/metadata/[a-f0-9]{16}$'
    )
...
class Tag(BaseModel):
    field_ref: Optional[str] = Field(
        None, alias='$ref', pattern='^/api/v1/tags/[a-f0-9]{16}$'
    )
...
class SequencingBatchSchema(BaseModel):
    ...
    batch_number: str = Field(
        ..., description='A unique batch number.', title='Batch Number'
    )
    created_at: str = Field(
        ...,
        description='Timestamp for when the object was created on the One Codex platform, encoded as a [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) timestamp.',
...
class WebhookSubscriptionSchema(BaseModel):
    ...
    post_url: AnyUrl = Field(..., title='Post Url')
...
class FieldTaxonomicResults(BaseModel):
    ...
    abundance_w_children: Optional[AbundanceWChildren] = Field(
...
class DocumentConfirmUploadResponse(BaseModel):
    ...
    message: str = Field(
        ..., description='A success or error message.', title='Message'
    )
    success: bool = Field(
        ..., description='Whether the upload was successful.', title='Success'
    )
...
class JobRunAnalysisSchema(BaseModel):
    ...
    populate_default_arguments: Optional[bool] = Field(
        True, title='Populate Default Arguments'
    )
    sample: SampleRef
...
class MetadataSchema(BaseModel):
    ...
    sample: Sample = Field(
        ..., description='The sample the metadata belongs to.', title='samples'
    )
    sample_type: Optional[SequencingSampleType] = Field(
        None, description='An enum with the sample type.'
    )
...
class SampleImportSchema(BaseModel):
    ...
    paired_uri: Optional[PairedUri] = Field(None, title='Paired Uri')
...
class SampleInitMultipartUploadSchema(BaseModel):
    ...
    metadata: Optional[InlineMetadata] = None
    paired_end_filename: Optional[PairedEndFilename] = Field(
        None, title='Paired End Filename'
    )
    project: Optional[ProjectRef] = None
...
class SampleInitUploadSchema(BaseModel):
    ...
    size: Optional[Size2] = Field(
        None, description='The size of the file in bytes.', title='Size'
    )
...
class SampleSchema(BaseModel):
    ...
    filename: Optional[str] = Field(
        None, description='The sample filename.', title='Filename'
    )
