...
from onecodex.requests_client import OneCodexHTTPClient, ModelHTTPClient
...
class Api:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs.pop("cache_schema", None)  # Not used in new implementation
        kwargs.pop("schema_path", None)  # Not used in new implementation
        kwargs.pop("experimental", None)  # TODO: Support experimental API
        ...
        self._session = getattr(self._http_client, "session", None)  # For tests
        self._client = self._http_client  # Alias for compatibility
    ...
    def _bind_models(self):
        ...
        from onecodex.models.analyses import (
            Analyses,
            Classifications,
            Alignments,
            FunctionalProfiles,
        ...
        from onecodex.models import build_model_lookup

        # Build the model lookup first
        build_model_lookup()
