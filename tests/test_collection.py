...
@pytest.mark.parametrize(
    ...
    [
        ...
        # This sample has abundances, so filtered readcount == readcount and these values match
        # their NormalizedReadcount* counterparts above.
        (
...
def test_mixed_abundance_status_no_warning(samples, samples_without_abundances, metric):
    """Filtered readcount metrics should not warn even when abundance status is mixed."""
